...
class ElectrodeConfig:
    ...
    def electrode_toggle(self, raw_data):
        if raw_data.new_data_size[1] > 100:
            ...
            self.electrode_coords_x = np.array([i[0] for i in self.mea_120_coordinates.values()])
            self.electrode_coords_y = np.array([i[1] for i in self.mea_120_coordinates.values()])
